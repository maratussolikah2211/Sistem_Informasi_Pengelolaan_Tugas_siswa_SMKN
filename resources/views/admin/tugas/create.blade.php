...
@section('sub_judul','Tambah Tugas Siswa')
@section('content')
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="{{ url('admin/tugas/store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      <label for="exampleFormControlSelect1">Pilih Matapelajaran</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" accept=".pdf" name="dokumen" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                        placeholder="Masukkan Nama Materi" required>
                    </div>
