          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="{{ url('admin/kelas/update', $kelas->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                         ...
                         <div class="form-group">
                              ...
                              <select class="form-control" name="id_guru" id="exampleFormControlSelect1">
                                   <option value="{{ $kelas->id_guru }}">{{ $kelas->user->name }}</option>
                         ...
                         <div class="form-group">
                              ...
                              <input type="text" name="nama_kelas" class="form-control" id="exampleInput" placeholder="Nama Kelas" value="{{ $kelas->nama_kelas }}">
                              @error('nama_kelas')
                                <div class="text-danger mt-2 text-sm">{{ $message }}</div>
                              @enderror
                         </div>
